    ...
    <header className="bg-primary fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        {cartItems && cartItems.length > 0 && (
              ...
              <p className="text-xs text-white font-seibold">{cartItems.length}</p>
            </div>
        )}
          </div>
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "kpeti962@gmail.com" && (
                  <Link to={"/createItem"}>
            ...
            >
              ...
              <ul className="flex flex-col">
                <Link to={"/"}><li
                  ...
                  className="hover:bg-slate-100 px-4 py-2 text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer"
                >
                  Home
                </li></Link>
                <li
